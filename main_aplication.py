...
def main():
    ...
    print(f"El valor promedio del pasaje económico es: {average_formatted_economy_ticket}")
    print("-" * 30)
    ...
    print("-" * 50)
    # Pregunta 10
    print(f"El avión que transportó mas pasajeros es: {sorted_passengers[-1]['airplane']}")
    print("-" * 30)
